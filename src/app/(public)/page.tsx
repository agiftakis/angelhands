...
function Homepage() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 mt-20 py-5">
      <div className="px-10 flex flex-col gap-7 justify-center">
        ...
        <p className="text-sm font-medium mt-4">
          ...
          to us. Let us extend our Angel Hands to you, providing the dependable,
          compassionate care you deserve. We're more than just a home care
          agency; we're a supportive extension of your family, ready to assist
          with a helping hand.
        </p>
